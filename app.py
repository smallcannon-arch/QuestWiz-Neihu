...
2. **學習目標對應**：
   - 學習目標必須原文採自教材內容。 [cite: 2026-02-13]
   - 確保每一條學習目標在「整份試卷」中至少對應到一題即可。 [cite: 2026-02-13]
   - **不須**強制每一種題型都對應到所有的學習目標，請根據教學重點彈性分佈題號。 [cite: 2026-02-13]
...
# --- Phase 2: 確認與出題 ---
    ...
    if len(st.session_state.chat_history) > 1:
        ...
        if prompt := st.chat_input("微調題目細節？"):
